...
function Pay() {
    ...
    const handlePayment = async () => {
        ...
        const data = {
            ...
            approval_url: `http://54.180.101.194/payment/success`, // Set your success URL
            fail_url: 'http://54.180.101.194/payment/fail', // Set your fail URL
            cancel_url: 'http://54.180.101.194/payment/cancel', // Set your cancel URL
        };
        console.log(data);
        try {
